    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          description="We deep-dive into your brand, goals, and target audience. We identify the right platforms, content formats, and creator archetypes to maximize your campaign's impact."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="We tap into our vetted network of 10,000+ creators to find the perfect brand fit. We handle all negotiations, contracts, and briefings — keeping you updated every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="We launch, monitor, and optimise your campaign in real time. You receive transparent performance reports tracking reach, engagement, conversions, and ROAS — so every dollar is accounted for."
        >
          <CanvasRevealEffect
            animationSpeed={3}
